...
{
    public partial class frmEnfermeiro : Form
    {
        ...
        private void Carrega_Grid() // Carrega e Consulta por Nome.
        {
            try
            {
                ...
                dgvEnfermeiros.DataSource = null; // Dgv Escondido atras do Picturebox.
                dgvEnfermeiros.DataSource = Ecolecao;
                dgvEnfermeiros.Update();
                dgvEnfermeiros.Refresh();
            }
            catch (Exception ex)
            {
        ...
        private void ConsultaPorId()
        {
            try
            {
                ...
                dgvEnfermeiros.DataSource = null;
                dgvEnfermeiros.DataSource = Ecolecao;
                dgvEnfermeiros.Update();
                dgvEnfermeiros.Refresh();
            }
        ...
        private void Inserir()
        {
            try
            {
                if (txtCodigo.ReadOnly == false && txtNome.ReadOnly == false && txtEndereco.ReadOnly == false && txtCoren.ReadOnly == false && txtCpf.ReadOnly == false && txtRg.ReadOnly == false && txtTelefone.ReadOnly == false && txtCelular.ReadOnly == false && txtEmail.ReadOnly == false)
                {
                    ...
                    enfermagem.IdEnfermeiro = Convert.ToInt32(txtCodigo.Text);
                    enfermagem.NomeEnfermeiro = txtNome.Text;
                    enfermagem.Endereco = txtEndereco.Text;
                    enfermagem.COREN = txtCoren.Text;
                    enfermagem.CPF = txtCpf.Text;
                    enfermagem.RG = txtRg.Text;
                    enfermagem.Telefone = txtTelefone.Text;
                    enfermagem.Celular = txtCelular.Text;
                    enfermagem.Email = txtEmail.Text;
                    dgvEnfermeiros.DataSource = Nenfermagem.Insere_Enfermagem(enfermagem);
                }
                else
                {
                    //
        ...
        private void Alterar()
        {
            try
            {
                if (txtCodigo.ReadOnly == false && txtNome.ReadOnly == false && txtEndereco.ReadOnly == false && txtCoren.ReadOnly == false && txtCpf.ReadOnly == false && txtRg.ReadOnly == false && txtTelefone.ReadOnly == false && txtCelular.ReadOnly == false && txtEmail.ReadOnly == false)
                {
                    ...
                    enfermagem.Celular = txtCelular.Text;
                    enfermagem.Email = txtEmail.Text;
                    dgvEnfermeiros.DataSource = Nenfermagem.Altera_Enfermagem(enfermagem);
                }
                else
                {
                    //
        ...
        private void Deletar()
        {
            try
            {
                ...
                enfermagem.IdEnfermeiro = Convert.ToInt32(txtCodigo.Text);
                dgvEnfermeiros.DataSource = Nenfermagem.Exclui_Enfermagem(enfermagem);
            }
            catch (Exception ex)
            {
                MessageBox.Show("ERRO, Detalhe :" + ex.Message);
        ...
        private void frmEnfermeiro_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void dgvEnfermeiros_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow row = this.dgvEnfermeiros.Rows[e.RowIndex];
        ...
        private void txtBuscaNome_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                Carrega_Grid();
                if (dgvEnfermeiros.Rows.Count == 0)
                {
        ...
        private void btnInserir_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("Select COREN  From tblEnfermeiro Where COREN = @COREN", conn);
            ...
            reader.Close();
            SqlCommand cmd1 = new SqlCommand("Select CPF  From tblEnfermeiro Where CPF = @CPF", conn);
            ...
            reader.Close();
            reader1.Close();
            SqlCommand cmd2 = new SqlCommand("Select RG  From tblEnfermeiro Where RG = @RG", conn);
            ...
            {
                MessageBox.Show("Para Adicionar um(a) Novo(a) Enfermeiro(a), clicar Prieiramente no Botão (Novo(a) Enfermeiro(a))", "SISTEMA HOSPITALAR", MessageBoxButtons.OK, MessageBoxIcon.Information);
                btnNovo.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("Para Inserção de novo(a) Enfermeiro(a) é Necessário Preencher todos os campos.", "SISTEMA HOSPITALAR", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                Limpa_Campos();
                txtCodigo.Focus();
                return;
            }
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            DialogResult perg = MessageBox.Show("Deseja Relamente Excluir o Registro deste(a) Enfermeiro(a) ?", "SISTEMA HOSPITALAR", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void frmEnfermeiro_Load(object sender, EventArgs e)
        {
