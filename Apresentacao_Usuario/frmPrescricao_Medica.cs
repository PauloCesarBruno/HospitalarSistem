      ...
      .DisableCloseButton(this.Handle.ToInt32()); // Desabilitar o "X".           
        ...
        private void btnGerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //===================================
                String nomeArquivoPDF = @"C:\Users\pf\Documents\Sistema Hospitalar\Prescrições Médicas\" + "Prescrição Médica " + cmbPaciente.SelectedItem + DateTime.Now.ToString(" dd_MM_yyyy-HH_mm_ss") + ".pdf";
