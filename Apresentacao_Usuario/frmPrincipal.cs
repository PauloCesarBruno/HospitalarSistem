...
namespace Apresentacao_Usuario
{
    public partial class frmPrincipal : Form
    {
        ...
        public DateTime outraData = Convert.ToDateTime("20/12/2023");
        //======================================================================
        ...
        private void frmPrincipal_Load(object sender, EventArgs e)
        {
            ...
            if (System.DateTime.Now.ToShortDateString() == "15/12/2023" || System.DateTime.Now.ToShortDateString() == "16/12/2023" ||
            System.DateTime.Now.ToShortDateString() == "17/12/2023" || System.DateTime.Now.ToShortDateString() == "18/12/2023" ||
            System.DateTime.Now.ToShortDateString() == "19/12/2023")
            {
                MessageBox.Show("ATENÇÃO: A sua chave expira em 20/12/2023, entre em contato com o desenvolvedor para renovar a chave antes da data de expiração evitando o bloqueio do sistema !!!", "SISTEME HOSPITALAR", MessageBoxButtons.OK, MessageBoxIcon.Warning);
