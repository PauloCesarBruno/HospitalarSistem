...
namespace Apresentacao_Usuario
{
    public partial class frmConsultaMedicos : Form
    {
        ...
        {
            InitializeComponent();
            dgvConsultaMedicos.AutoGenerateColumns = false;
        }
        ...
        private void CarregarGrid() // Carrega e Consulta por Nome.
        {
            try
            {
                ...
                dgvConsultaMedicos.DataSource = null;
                dgvConsultaMedicos.DataSource = Mcolecao;
                dgvConsultaMedicos.Update();
                dgvConsultaMedicos.Refresh();
            }
            catch (Exception ex)
            {
        ...
        private void txtBuscaNome_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                CarregarGrid();
                if (dgvConsultaMedicos.Rows.Count == 0)
                {
                ...
                txtCapCodigo.Text = dgvConsultaMedicos.CurrentRow.Cells[0].Value.ToString();
            }
            catch (Exception)
            {
                //
        ...
        private void frmConsultaMedicos_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void dgvConsultaMedicos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow row = this.dgvConsultaMedicos.Rows[e.RowIndex];
